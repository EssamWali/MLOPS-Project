    ...
    def detect_drift_evidently(self, current_data: pd.DataFrame) -> Dict:
        ...
        try:
            ...
            results = {
                ...
                "drift_ratio": (
                    len(drifted_features) / len(common_cols) if common_cols else 0
                ),
        ...
        for feature in self.feature_columns:
            ...
            try:
                ...
                if p_value < 0.05:
                    ...
                    mean_shift = abs(ref_values.mean() - curr_values.mean()) / (
                        ref_values.std() + 1e-10
                    )
...
def monitor_data_drift(
    reference_data_path: str, current_data_path: str, threshold: float = 0.7
) -> Dict:
    """

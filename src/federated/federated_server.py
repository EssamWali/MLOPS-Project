...
class FederatedServer:
    ...
    def _fit_config(self, rnd: int) -> Dict:
        ...
        return {"round": rnd, "epochs": 1, "batch_size": 32, "learning_rate": 0.01}
...
def start_federated_server(
    num_clients: int = 5, rounds: int = 10, server_address: str = "0.0.0.0:8080"
):
    """
    ...
    """
    server = FederatedServer(num_clients=num_clients, rounds=rounds)

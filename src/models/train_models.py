...
def train_all_models():
    ...
    wearable_data_path = Path(__file__).parent.parent.parent / "data" / "raw" / "wearable_data.csv"
    ...
    air_quality_path = Path(__file__).parent.parent.parent / "data" / "raw" / "air_quality_data.csv"
    ...
    weather_path = Path(__file__).parent.parent.parent / "data" / "raw" / "weather_data.csv"
    if weather_path.exists():
        ...
        for model_type in model_types:
            ...
            metrics = model.train(df_weather, target_col=None)  # Derives risk from weather
    ...
    results_path = reports_dir / f"model_training_results_{datetime.now().strftime('%Y%m%d_%H%M%S')}.json"

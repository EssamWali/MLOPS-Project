...
class MLflowTracker:
    ...
    def __init__(self, experiment_name: str = "health-risk-prediction",
    ...
    def log_model_training(self, model, model_name: str, metrics: Dict[str, float],
                          parameters: Dict[str, Any], feature_names: Optional[list] = None,
    ...
    def log_prediction(self, model_name: str, predictions: np.ndarray,
                      input_data: pd.DataFrame, output_path: Optional[str] = None):
        """
        Log predictions
    ...
    def register_model(self, run_id: str, model_name: str, model_version: str = "latest"):
        """
...
def track_model_training(model, model_type: str, dataset_type: str,
